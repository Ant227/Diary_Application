...
class EntrySelectProjectListAdapter(private val clickListener:EntrySelectProjectListener) : ListAdapter<Project, ProjectViewHolder>(ProjectDiffCallback())
{
...
interface EntrySelectProjectListener {
